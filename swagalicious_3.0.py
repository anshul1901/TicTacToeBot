...
class Swagalicious():
	...
	def heuristic2(self, board, depth, isMax, flag, old_move):
        ...
        # Checking for flower
		if bs[0][1] == bs[1][0] and bs[1][2] == bs[2][1] and bs[0][1] == flag and not bs[1][2] == alt_flag or bs[1][2] == bs[1][0] and bs[0][1] == bs[i][2] and bs[1][2] == flag and not bs[0][1] == alt_flag or bs[1][0] == bs[2][1] and bs[1][2] == bs[0][1] and bs[1][0] == flag and not bs[1][2] == alt_flag or bs[1][2] == bs[2][1] and bs[0][1] == bs[1][0] and bs[1][2] == flag and not bs[0][1] == alt_flag or bs[0][1] == bs[2][1] and bs[1][0] == bs[1][2] and bs[0][1] == flag and not bs[1][2] == alt_flag or bs[1][2] == bs[0][1] and bs[1][0] == bs[1][2] and bs[1][2] == flag and not bs[1][0] == alt_flag:
			score += 50
		if bs[1][1] == bs[1][0] and bs[1][3] == bs[2][1] and bs[1][1] == flag and not bs[1][3] == alt_flag or bs[1][3] == bs[1][0] and bs[1][1] == bs[i][2] and bs[1][3] == flag and not bs[1][1] == alt_flag or bs[1][0] == bs[2][1] and bs[1][3] == bs[1][1] and bs[1][0] == flag and not bs[1][3] == alt_flag or bs[1][3] == bs[2][1] and bs[1][1] == bs[1][0] and bs[1][3] == flag and not bs[1][1] == alt_flag or bs[1][1] == bs[2][1] and bs[1][0] == bs[1][3] and bs[1][1] == flag and not bs[1][3] == alt_flag or bs[1][3] == bs[1][1] and bs[1][0] == bs[1][3] and bs[1][3] == flag and not bs[1][0] == alt_flag:
			score += 50
		if bs[0][1] == bs[1][0] and bs[1][2] == bs[2][1] and bs[0][1] == flag and not bs[1][2] == alt_flag or bs[1][2] == bs[1][0] and bs[0][1] == bs[i][2] and bs[1][2] == flag and not bs[0][1] == alt_flag or bs[1][0] == bs[2][1] and bs[1][2] == bs[0][1] and bs[1][0] == flag and not bs[1][2] == alt_flag or bs[1][2] == bs[2][1] and bs[0][1] == bs[1][0] and bs[1][2] == flag and not bs[0][1] == alt_flag or bs[0][1] == bs[2][1] and bs[1][0] == bs[1][2] and bs[0][1] == flag and not bs[1][2] == alt_flag or bs[1][2] == bs[0][1] and bs[1][0] == bs[1][2] and bs[1][2] == flag and not bs[1][0] == alt_flag:
			score += 50
		if bs[0][1] == bs[1][0] and bs[1][2] == bs[2][1] and bs[0][1] == flag and not bs[1][2] == alt_flag or bs[1][2] == bs[1][0] and bs[0][1] == bs[i][2] and bs[1][2] == flag and not bs[0][1] == alt_flag or bs[1][0] == bs[2][1] and bs[1][2] == bs[0][1] and bs[1][0] == flag and not bs[1][2] == alt_flag or bs[1][2] == bs[2][1] and bs[0][1] == bs[1][0] and bs[1][2] == flag and not bs[0][1] == alt_flag or bs[0][1] == bs[2][1] and bs[1][0] == bs[1][2] and bs[0][1] == flag and not bs[1][2] == alt_flag or bs[1][2] == bs[0][1] and bs[1][0] == bs[1][2] and bs[1][2] == flag and not bs[1][0] == alt_flag:
